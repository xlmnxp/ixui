...
function SpiceConn(o)
{
    ...
    // Do NOT request the 'binary' WebSocket subprotocol: incusd does not
    // select any subprotocol, and browsers abort the handshake when a
    // requested protocol is not negotiated. Binary framing is set below via
    // the wire reader's binaryType = "arraybuffer".
